...
if (isset($_GET['registerId']) && isset($_GET['visitingId'])) {
  $registerId=$_GET['registerId'];
  $visitingId=$_GET['visitingId'];
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="./register.php">Home</a></li>
    ...
    <section class="section">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Visitor Registration</h5>
                ...
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Visiting ID</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['visitingID']?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Name of Visitor</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['nameOfVisit']?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Organization / Address</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['org']?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Date of Visiting</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['date']?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Contact Number</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['no']?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Vehicle Number</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['vehicleno']?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Purpose</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['purpose']?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Meeting Person Name</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['meetingName']?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label ">Registered By</div>
                  <div class="col-lg-9 col-md-8"><?=$getVerifyData['registerEmail']?></div>
                </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Update Visitor Registration</h5>
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nameOfVisit" value="<?=$getVerifyData['nameOfVisit']?>" required >
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Organization / Address</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="org" value="<?=$getVerifyData['org']?>" required>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="number" value="<?=$getVerifyData['no']?>" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Vehicle Number</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="vehicle" value="<?=$getVerifyData['vehicleno']?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Purpose</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="purpose" value="<?=$getVerifyData['purpose']?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Meeting Person Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" value="<?=$getVerifyData['meetingName']?>" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" value="<?=$getVerifyData['registerEmail']?>" name="email" readonly>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="campus" value="<?=$getVerifyData['campus']?>" id="campus" readonly>
                  </div>
                </div>
                <div class="row mb-3">
