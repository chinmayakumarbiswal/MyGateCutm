    ...
    return (function () {
                                    ...
                                    var O = function () {
                                            ...
                                            D.startOf = function (t, e) {
                                                var n = this,
                                                    ...
                                                    $ = function (t, e) {
                                                        return w.w(n.toDate()[t].apply(n.toDate("s"), (
                                                            r
                                                                ? [0, 0, 0, 0]
                                                                : [23, 59, 59, 999]
                                                        ).slice(e)), n)
                                            ...
                                            D.$set = function (t, e) {
                                                ...
                                                if (u === f || u === c) {
                                                    ...
                                                    M.init(),
                                                    this.$d = M
                                                        .set(d, Math.min(this.$D, M.daysInMonth()))
                                                        .$d
                                                } else 
                                                    l && this.$d[l]($);
                                                return this.init(),
        ...
        2: [
            function (require, module, exports) {
                ...
                const t = t => "[object Object]" === Object
                        .prototype
                        .toString
                        .call(t),
                    e = (t, e) => {
                    ...
                    rebuild() {
                        ...
                        a
                            ...
                            .forEach(((h, r) => {
                                ...
                                null !== h.searchIndex && void 0 !== h.searchIndex && (
                ...
                class o {
                    ...
                    renderPager() {
                        if (s(this.pagers), this.totalPages > 1) {
                            ...
                            this.options.nextPrev && !this.onFirstPage && s.appendChild(
                            ...
                            this
                                ...
                                .classList
                                .add("active"),
                            this.options.nextPrev && !this.onLastPage && s.appendChild(
                                i(t, n, this.options.nextText)
                            ),
                            this.options.firstLast && s.appendChild(
                                i(t, this.totalPages, this.options.lastText)
                            ),
                            this
                                .pagers
                                .forEach((t => {
                            ...
                            if (i.length) {
                                if ("txt" === o.type || "csv" === o.type) {
                                    ...
                                    for (r = `INSERT INTO \`${o.tableName}\` (`, n = 0; n < s.length; n++) 
                                        !o
                                            .skipColumn
                                            .includes(s[n].originalCellIndex) && this
                                            .columns(s[n].originalCellIndex)
                                            .visible() && (r += `\`${s[n].textContent}\`,`);
                                    for (
                                        ...
                                        for (r += "(", h = 0; h < i[n].cells.length; h++) 
                                            !o
                                                .skipColumn
                                                .includes(s[h].originalCellIndex) && this
                                                .columns(s[h].originalCellIndex)
                                                .visible() && (r += `"${i[n].cells[h].textContent}",`);
                                        r = r
                                            .trim()
                                            .substring(0, r.length - 1),
                                        r += "),"
                                    ...
                                    for (h = 0; h < i.length; h++) 
                                        for (a[h] = a[h] || {}, n = 0; n < s.length; n++) 
                                            !o
                                                ...
                                                .includes(s[n].originalCellIndex) && this
                                                .columns(s[n].originalCellIndex)
                                                .visible() && (a[h][s[n].textContent] = i[h].cells[n].textContent);
