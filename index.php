<?php
    ...
    $redirectURL='http://localhost/mygatecutm/index.php';
                        ...
                        <form class="md-float-material form-material" action="#" method="POST">
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 class="text-center heading">CUTM MyGate Student/Employee Login</h3>
                                    ...
                                    <p class="text-inverse text-center">Gate Login
                                        <a href="./gateLogin.php" data-abc="true">Login</a>
                                    </p>
                                </div>
                            </div>
                        </form>
