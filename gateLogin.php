<?php
    ...
    $redirectURL='http://localhost/mygatecutm/gateLogin.php';
    ...
    if (isset($_GET['code'])) {
        ...
        if($totalRows >=1){
            ...
            $_SESSION['userType']="gate";
            header('location:./gateLogin/report.php');
                        ...
                        <form class="md-float-material form-material" action="#" method="POST">
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 class="text-center heading">CUTM MyGate Gate Login</h3>
